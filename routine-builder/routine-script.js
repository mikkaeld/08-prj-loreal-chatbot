...
// Using global marked from CDN instead of ES6 import
...
console.log('Routine Builder Debug:');
console.log('categoryFilter:', categoryFilter);
console.log('productsContainer:', productsContainer);
console.log('chatForm:', chatForm);
console.log('chatWindow:', chatWindow);
console.log('generateRoutineBtn:', generateRoutineBtn);
...
async function generateRoutine() {
  console.log('Generate routine function called'); // Debug log
  ...
  try {
    ...
    // Create a detailed routine request with full product information
    const routineRequest = `Create a personalized skincare/beauty routine using these specific products:
...
2. Recommended time of day for each product
3. Application tips and techniques
4. Any compatibility considerations between products
5. Expected benefits from this routine
...
Make the routine practical and easy to follow.`;
    ...
    chatWindow.insertAdjacentHTML('beforeend', `
      <div class="message user-message" id="${userMessageId}">
        <strong>🪄 Generating your personalized routine...</strong><br>
        Using ${selectedProducts.length} selected product${selectedProducts.length > 1 ? 's' : ''}
      </div>
    `);
...
// Debug: Confirm event listener is added
console.log('Generate routine button event listener added');
